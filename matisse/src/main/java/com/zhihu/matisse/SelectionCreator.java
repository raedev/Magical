...
public final class SelectionCreator {
    ...
    private boolean checkPermissions(final int requestCode) {
        ...
        int storageGranted = ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        // 没有授权访问
        if (storageGranted == PackageManager.PERMISSION_DENIED || cameraGranted == PackageManager.PERMISSION_DENIED) {
