...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void sendBackResult(boolean apply) {
        ...
        intent.putExtra(MatisseActivity.EXTRA_RESULT_ORIGINAL_ENABLE, mOriginalEnable);
        intent.putStringArrayListExtra(MatisseActivity.EXTRA_RESULT_SELECTION_PATH, new ArrayList<>(mSelectedCollection.asListOfString()));
        intent.putParcelableArrayListExtra(MatisseActivity.EXTRA_RESULT_SELECTION, new ArrayList<>(mSelectedCollection.asListOfUri()));
